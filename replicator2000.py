...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">PSAT - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">PSAT Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("PSAT - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" PSAT - Khan's Tutorial</title>")
    newBString = bannerString.replace("PSAT Tutoring</h1>",nbrhood.replace('-',' ')+" PSAT Tutoring</h1>")
